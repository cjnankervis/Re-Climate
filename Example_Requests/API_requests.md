...
| --------------- | ------------- | ------------------------------------------------------------ |
| country           | string        | <sub>**REQUIRED** geography/ mainland country area; either "uk", "spain" or "turkey" {"uk" ONLY for gauges product}</sub> |
...
| Element         | Type          | Description                                                  |
| --------------- | ------------- | ------------------------------------------------------------ |
| country           | string        | <sub>**REQUIRED** geography/ mainland country area; either "uk", "spain" or "turkey" {"uk" ONLY for gauges product} |
| instance_name    | string        | <sub>**NOT REQUIRED** necessary for tailored/ bespoke client requests only</sub> |
