...
Example A. Using "JSON_Postprocessing.py" to calculate the 90th centile of ensemble members with consecutive dry days with 24-hour accumulated precipitation of less than 1mm
...
Example B. Using "CSV_Postproccessing.py" to calculate an ensemble average of conseuctive days with tropical nights (T<sub>min</sub> > 20°C) for the multi-model benchmark/ numerical weather prediction models
