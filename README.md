...
- **[Re-Climate® Validators](https://seasonalforecasts.earth/docs/pricing/)**, access to historic seasonal forecasts
...
|API Technical<br />Specifications | <sub>Monthly<br /> Forecasts</sub> | <sub>Daily<br /> Ensembles</sub> | <sub>Hazard<br /> Indices</sub> | <sub>Departures<br /> (Anomalies)</sub> | <sub>Daily Quantile<br />(Q-Q) Plots</sub> | <sub>Graphical<br /> Summaries</sub> |
| ------------- | ------------- | ------------- | ------------- | ------------- | ------------- | ------------- |
...
<center><img src="https://seasonalforecasts.earth/wp-content/uploads/2023/04/SoilMoisture_July2022.png" alt "Volumetric soil moisture forecast for July 2022 width="80%"></center>
