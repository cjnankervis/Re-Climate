...
To request this climate data, see example [MonthlyCentiles_example.json]
...
To request this climate data, see example [DailyEnsembles_example.json]
...
To request this climate data, see example [HazardIndices_example.json]
...
To request this climate data, see example [Anomalies_example.json]
