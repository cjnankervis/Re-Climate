...
| <sub>Confidence Intervals (100<br /> Ensemble Members  'E' or<br /> Centile Bands 'C' or Shift-<br />of-the-Tails 'T')</sub> | C | E | T | C |
| <sub>Temporal Granularity<br /> (Seasonal 'S' or Monthly 'M'<br /> or Daily 'D')</sub> | M | D | S, M | M |
| <sub>Spatially Correlated Daily<br /> Event Generation</sub> | :white_check_mark: | :white_check_mark:  | :x: | :x: |
