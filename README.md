...
| ------------- | ------------- | ------------- | ------------- | ------------- |
| <sub>Country-wide Forecasts<br /> (Downscaled to a 5km<br /> Regular Grid)</sub> | :heavy_check_mark: | <sub>Content Cell</sub> | <sub>Content Cell</sub> | :heavy_check_mark: |
| <sub>Town-level Modelling<br /> (Closest Location Match)</sub> | <sub>Content Cell</sub> | :heavy_check_mark: | :heavy_check_mark: | <sub>Content Cell</sub> |
...
| <sub>Spatially Correlated Daily<br /> Event Generation</sub> | :heavy_check_mark: | :heavy_check_mark:  | <sub>Content Cell</sub> | <sub>Content Cell</sub> |
| <sub>Combines NWP with<br /> Statistical Model</sub> | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
| <sub>Validated by the National<br /> Physical Laboratory</sub> | <sub>Content Cell</sub> | :heavy_check_mark: | <sub>Content Cell</sub> | <sub>Content Cell</sub> |
| <sub>Weather Variability as a<br /> Function of Numerical<br /> Model Output</sub> | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
| <sub>Forecast Trained<br /> to Local Geography</sub> | Content Cell</sub> | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
| <sub>Chronic & Acute Physical<br /> Climate Change<br /> Adjustments</sub> | :heavy_check_mark: | :heavy_check_mark: | <:heavy_check_mark: | :heavy_check_mark: |
