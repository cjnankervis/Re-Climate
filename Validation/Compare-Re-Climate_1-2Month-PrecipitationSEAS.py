...
for lead_time in lead_times:
    ...
    # Save
    if len(forecasts) == 1:
        plt.savefig(f'raw_data/ReClimate_{SEASON}_{start_years[len(start_months)-1]}_{lead_time}{forecast}.png', dpi=150, bbox_inches='tight')
    else:
        plt.savefig(f'raw_data/ReClimate_{SEASON}_{start_years[len(start_months)-1]}_{lead_time}COMBINED.png', dpi=150, bbox_inches='tight')
    # Show forecast plots
    plt.show()
