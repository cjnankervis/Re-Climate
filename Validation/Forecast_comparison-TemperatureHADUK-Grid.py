...
for model_type in range(3):
    ...
    # Save Plot
    plt.savefig(f'raw_data/Re-ClimateActuals_HADUK_Grid_Pearson{output_ext[model_type]}.png', dpi=150, bbox_inches='tight')
    plt.show(block=False)
    ...
    # Save Plot
    plt.savefig(f'raw_data/Re-ClimateActuals_HADUK_Grid_RMS{output_ext[model_type]}.png', dpi=150, bbox_inches='tight')
    plt.show(block=False)
