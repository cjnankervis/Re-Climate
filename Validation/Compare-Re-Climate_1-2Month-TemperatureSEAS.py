...
start_years = ['2024','2024','2024'] # ['2023','2023','2023','2024','2024','2024'] # Forecast initiation years
start_months = ['06','07','08'] # ['10','11','12','01','02','03','04','05','06','07','08'] # Forecast start/ valid month
...
for lead_time in lead_times:
    ...
    # Save
    if len(forecasts) == 1:
        plt.savefig(f'raw_data/ReClimate_{SEASON}_{start_years[len(start_months)-1]}_{lead_time}_Temperature{forecast}.png', dpi=350, bbox_inches='tight')
    else:
        plt.savefig(f'raw_data/ReClimate_{SEASON}_{start_years[len(start_months)-1]}_{lead_time}_TemperatureCOMBINED.png', dpi=350, bbox_inches='tight')
    # Show forecast plots
    plt.show()
