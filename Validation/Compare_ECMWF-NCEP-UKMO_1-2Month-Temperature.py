...
start_years = ['2024'] # ['2023','2023','2023','2024','2024','2024','2024','2024','2024','2024'] # Forecast initiation years
start_months = ['08'] # ['10','11','12','01','02','03','04','05','06','07'] # Forecast start/ valid month
...
for supplier in suppliers:
    ...
    for mth_index, start_month in enumerate(start_months):
        ...
        if not os.path.isfile(f'raw_data/comparison_{start_month}_{start_years[mth_index]}_{supplier}_Temperature.grib'):
            import cdsapi
            c = cdsapi.Client()
            c.retrieve(
                ...
                f'raw_data/comparison_{start_month}_{start_years[mth_index]}_{supplier}_Temperature.grib')
        ...
        for lead_time in lead_times:
            ...
            # Save Plot
            plt.savefig(f'raw_data/comparison_{start_month}_{start_years[mth_index]}_{lead_time}_{supplier}_Temperature.png', dpi=150, bbox_inches='tight')
